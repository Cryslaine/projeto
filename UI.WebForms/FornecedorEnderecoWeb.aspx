...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
      <asp:Label ID="Label2" runat="server" BorderColor="Black" Font-Bold="True" Font-Italic="True" Font-Names="Georgia" Style="z-index: 1; left: 270px; top: 125px; position: absolute; width: 188px; right: 548px;" Text="Endereço Fornecedor"></asp:Label>
    ...
    <asp:Label ID="LbEndereco" runat="server" Style="z-index: 1; left: 270px; top: 230px; position: absolute" Text="Endereço:" Font-Bold="True" Font-Names="Arial" ForeColor="#0000CC"></asp:Label>
     <asp:TextBox ID="txtEndereco" runat="server" Style="z-index: 1; left: 270px; top: 250px;height:30px; position: absolute; width: 226px" TabIndex="9" BorderStyle="Inset" MaxLength="30"></asp:TextBox>
    ...
    <asp:DropDownList ID="ddlFornecedorEmpresa" runat="server" Style="z-index: 1; left: 270px; top: 200px;height:30px; position: absolute" TabIndex="8" Font-Bold="True">
        </asp:DropDownList>
    <asp:Label ID="LbN" runat="server" Style="z-index: 1; left: 550px; top: 230px; position: absolute" Text="Nº" Font-Bold="False" Font-Names="Arial" ForeColor="#0000CC"></asp:Label>
        <asp:TextBox ID="txtCidade" runat="server" Style="z-index: 1; left: 270px; top: 310px;height:30px; position: absolute; width: 198px" TabIndex="12" BorderStyle="Inset"></asp:TextBox>
     <asp:TextBox ID="txtNumero" runat="server" Style="z-index: 1; left: 550px; top: 250px; position: absolute; width: 44px; height: 30px;" TabIndex="10" BorderStyle="Inset" MaxLength="5"></asp:TextBox>
        <asp:TextBox ID="txtBairro" runat="server" Style="z-index: 1; left: 650px; top: 250px; position: absolute;height:30px; width: 263px" TabIndex="11" BorderStyle="Inset" MaxLength="20"></asp:TextBox>
    <asp:TextBox ID="txtCep" runat="server" Style="z-index: 1; left: 650px; top: 310px; position: absolute; height: 30px" TabIndex="14" BorderStyle="Inset" MaxLength="9"></asp:TextBox>
        <asp:TextBox ID="txtComplemento" runat="server" Style="z-index: 1; left: 270px; top: 380px;height:30px; position: absolute; width: 220px" TabIndex="15" BorderStyle="Inset" MaxLength="15"></asp:TextBox>
    ...
    <asp:Label ID="LbBairro" runat="server" Style="z-index: 1; left: 650px; top: 230px; position: absolute" Text="Bairro:" Font-Bold="True" Font-Names="Arial" ForeColor="#0000CC"></asp:Label>
     <asp:TextBox ID="txtUf" runat="server" Style="z-index: 1; left: 550px; top: 310px; position: absolute; width: 43px; height: 30px;" TabIndex="13" BorderStyle="Inset" MaxLength="2"></asp:TextBox>
    <asp:Button ID="btnSalvarEndereco" runat="server" OnClick="txtSalvarEndereco_Click" Style="z-index: 1; left: 541px; top: 400px; position: absolute; height: 30px;" Text="Salvar" Font-Names="Arial Black" />
        <asp:Button ID="btnEditarEndereco" runat="server" OnClick="btnEditarEndereco_Click" Style="z-index: 1; left: 651px; top: 400px;height:30px; position: absolute" Text="Editar" Font-Names="Arial Black" />
    <asp:Button ID="btnCancelarEndereco" runat="server" OnClick="btnCancelarEndereco_Click" Style="z-index: 1; left: 746px; top: 400px;height:30px;position: absolute" Text="Cancelar" Font-Names="Arial Black" />
