...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    <div>
        ...
        <p>
            ...
            <asp:TextBox ID="txtRazaoSocial" runat="server" Style="z-index: 1; left: 237px; top: 325px; position: absolute; width: 427px; height: 20px;" TabIndex="1" BorderStyle="Solid" MaxLength="50"></asp:TextBox>
            ...
            <asp:TextBox ID="txtNomeFantasia" runat="server" Style="z-index: 1; left: 695px; top: 320px; position: absolute; width: 314px; height: 20px;" TabIndex="2" BorderStyle="Solid" MaxLength="50"></asp:TextBox>
            <asp:TextBox ID="txtCnpjPesquia" runat="server" Style="z-index: 1; left: 602px; top: 226px; position: absolute; width: 161px;" BorderStyle="Solid" MaxLength="14"></asp:TextBox>
            ...
            <asp:TextBox ID="txtCnpj" runat="server" Style="z-index: 1; left: 241px; top: 406px; position: absolute; width: 230px" TabIndex="3" BorderStyle="Solid" MaxLength="14"></asp:TextBox>
            ...
            <asp:TextBox ID="txtEndereco" runat="server" Style="z-index: 1; left: 505px; top: 407px; position: absolute; height: 16px; width: 276px" TabIndex="4" BorderStyle="Solid" MaxLength="30"></asp:TextBox>
            ...
            <asp:TextBox ID="txtN" runat="server" Style="z-index: 1; left: 242px; top: 483px; position: absolute; width: 78px; height: 18px;" TabIndex="5" BorderStyle="Solid" MaxLength="5"></asp:TextBox>
            ...
            <asp:TextBox ID="txtBairro" runat="server" Style="z-index: 1; left: 370px; top: 488px; position: absolute; width: 227px" TabIndex="6" BorderStyle="Solid" MaxLength="20"></asp:TextBox>
            ...
            <asp:TextBox ID="txtCidade" runat="server" Style="z-index: 1; left: 636px; top: 487px; position: absolute; height: 18px;" TabIndex="7" BorderStyle="Solid" MaxLength="20"></asp:TextBox>
            ...
            <asp:TextBox ID="txtComplemento" runat="server" Style="z-index: 1; left: 470px; top: 572px; position: absolute; width: 239px;" TabIndex="10" BorderStyle="Solid" MaxLength="15"></asp:TextBox>
            <asp:TextBox ID="txtUf" runat="server" Style="z-index: 1; left: 243px; top: 567px; position: absolute; width: 48px; height: 19px" TabIndex="8" BorderStyle="Solid" MaxLength="2"></asp:TextBox>
            ...
            <asp:TextBox ID="txtCep" runat="server" Style="z-index: 1; left: 332px; top: 569px; position: absolute; width: 101px; height: 21px;" TabIndex="9" BorderStyle="Solid" MaxLength="9"></asp:TextBox>
            ...
            <asp:Button ID="btnSalvar" runat="server" Style="z-index: 1; left: 358px; top: 650px; position: absolute" Text="Salvar" OnClick="btnSalvar_Click" Font-Bold="True" />
            <asp:Button ID="btnLimpar" runat="server" Style="z-index: 1; left: 469px; top: 648px; position: absolute; height: 25px;" Text="Editar" OnClick="btnEditar_Click" Font-Bold="True" />
            <asp:Button ID="btnCancelar" runat="server" Style="z-index: 1; left: 572px; top: 651px; position: absolute" Text="Cancelar" OnClick="btnCancelar_Click" Font-Bold="True" />
        ...
        <asp:Label ID="LbEmpresa" runat="server" style="z-index: 1; left: 270px; top: 125px; position: absolute; width: 167px" Text="Cadastro Empresa" BackColor="#CCCCCC" BorderColor="Black" Font-Bold="True" Font-Italic="True" Font-Names="Georgia"></asp:Label>
        </p>
