<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ProdutoWeb.aspx.cs" Inherits="UI.WebForms.ProdutoWeb" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    <p style="width: 877px;">
        ...
        <asp:DropDownList ID="ddlFornecedo" runat="server" Style="z-index: 1; left: 270px; top: 235px; position: absolute; height: 22px; width: 108px;" AppendDataBoundItems="True" DataTextField="Nome" DataValueField="IdFornecedor" Font-Bold="True">
        </asp:DropDownList>
        ...
        <asp:DropDownList ID="ddlQuantidade" runat="server" Style="z-index: 1; left: 755px; top: 230px; position: absolute" Font-Bold="True" Font-Italic="False">
        ...
        <asp:TextBox ID="txtPreco" runat="server" Style="z-index: 1; left: 275px; top: 310px; position: absolute; height: 15px; width: 102px" TabIndex="3" BorderStyle="Solid" Font-Bold="False" MaxLength="10"></asp:TextBox>
        ...
        <asp:TextBox ID="txtTamanho" runat="server" Style="z-index: 1; left: 450px; top: 310px; position: absolute" TabIndex="4" BorderStyle="Solid" TextMode="Number"></asp:TextBox>
        ...
        <asp:DropDownList ID="ddlCor" runat="server" Style="z-index: 1; left: 810px; top: 310px; position: absolute; margin-bottom: 0px;" TabIndex="6" Font-Bold="True">
            <asp:ListItem>Selecione..</asp:ListItem>
        ...
        <asp:TextBox ID="txtPeso" runat="server" Style="z-index: 1; left: 630px; position: absolute; top: 310px" TabIndex="5" BorderStyle="Solid" MaxLength="10"></asp:TextBox>
        <asp:TextBox ID="txtNome" runat="server" Style="z-index: 1; left: 450px; top: 235px; position: absolute; width: 274px" TabIndex="1" BorderStyle="Solid" MaxLength="30"></asp:TextBox>
        ...
        <asp:Button ID="btnSalvar" runat="server" OnClick="btnSalvar_Click" Style="z-index: 1; left: 479px; top: 360px; position: absolute" Text="Salvar" Font-Names="Arial Black" />
        <asp:Button ID="btnEditar" runat="server" OnClick="btnEditar_Click" Style="z-index: 1; left: 580px; top: 360px; position: absolute; height: 26px" Text="Editar" Font-Names="Arial Black" />
        <asp:Button ID="btnCancelar" runat="server" OnClick="btnCancelar_Click" Style="z-index: 1; left: 677px; top: 360px; position: absolute" Text="Cancelar" Font-Names="Arial Black" />
        ...
        <asp:TextBox ID="txtPesquisa" runat="server" Style="z-index: 1; left: 430px; top: 460px; position: absolute; width: 189px" TabIndex="7"  BorderStyle="Solid" MaxLength="30"></asp:TextBox>
        ...
        <asp:Button ID="btnPesquiasr" runat="server" OnClick="btnPesquiasr_Click" Style="z-index: 1; left: 650px; top: 460px; position: absolute" Text="Pesquisar " Font-Names="Arial Black" />
        <asp:Label ID="LbProduto0" runat="server" Style="z-index: 1; left:270px; top: 100px; position: absolute; width: 192px" Text="Cadastro Produto" BackColor="#CCCCCC" BorderColor="Black" Font-Bold="True" Font-Italic="True" Font-Names="Georgia" ForeColor="Black"></asp:Label>
    </p>
    </asp:Content>
