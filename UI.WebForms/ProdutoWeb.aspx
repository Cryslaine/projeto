...
<asp:Content ID="Content2" ContentPlaceHolderID="content" runat="server">
    <p style="width: 877px;">
        ...
        <asp:Label ID="LbProduto0" runat="server" Style="z-index: 1; left:270px; top: 100px; position: absolute; width: 192px" Text="Cadastro Produto" BorderColor="Black" Font-Bold="True" Font-Italic="True" Font-Names="Georgia" ForeColor="Black"></asp:Label>
    </p>
    </asp:Content>
