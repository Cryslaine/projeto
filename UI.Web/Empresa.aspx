<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Empresa.aspx.cs" Inherits="UI.Web.Empresa" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:GridView ID="GvtelefoneEmpresa1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" style="z-index: 1; left: 29px; top: 639px; position: absolute; height: 133px; width: 441px" >
            <Columns>
        ...
        <asp:Label ID="Label1" runat="server" style="z-index: 1; left: 194px; top: 40px; position: absolute" Text="CNPJ:"></asp:Label>
